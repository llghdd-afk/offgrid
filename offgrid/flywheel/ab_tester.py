...
CANDIDATES_DIR = os.path.join(Path.home(), ".offgrid", "candidates")
...
class ABTester:
    ...
    def _run_backtest(self, expert_def: dict, source_trajectories: list[TaskTrajectory]) -> list[dict]:
        ...
        for traj in source_trajectories:
            ...
            if not project_root:
                ...
                project_root = tempfile.mkdtemp(prefix="offgrid_backtest_")
    ...
    def check_graduation(self, expert_name: str) -> str:
        ...
        if new_sr > baseline_sr + 0.10:
            ...
            try:
                from offgrid.cli.onboarding import load_config
    ...
    def run_prompt_optimization(
        ...
        try:
            from offgrid.flywheel.prompt_optimizer import PromptOptimizer
