"""
Trajectory collector: records task execution trajectories to ~/.offgrid/trajectories/.
...
TRAJECTORIES_DIR = os.path.join(Path.home(), ".offgrid", "trajectories")
...
class TrajectoryCollector:
    """Collects and persists task trajectories to ~/.offgrid/trajectories/."""
    ...
    def record(
        ...
        """Record a completed task. Saves to ~/.offgrid/trajectories/{task_id}.json."""
