...
class TestToolExecutor:
    def test_read_write_file(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Write
            assert tools.write_file("test.txt", "hello offgrid")
            assert content == "hello offgrid"
            assert tools.write_file("test.txt", "hello offgrid")
            assert content == "hello offgrid"
...
class TestOffgridMemory:
    def test_init_creates_file(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert os.path.exists(os.path.join(tmpdir, ".offgrid", "PROJECT.md"))
    ...
    def test_no_save_on_failure(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            from offgrid.memory import project_md, expert_md
