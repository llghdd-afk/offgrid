...
class TestModelCapability:
    ...
    def test_strategy_small(self):
        from offgrid.core.model_capability import get_strategy, ModelTier
    ...
    def test_tier_display_name(self):
        from offgrid.core.model_capability import tier_display_name, ModelTier
...
class TestValueTracker:
    ...
    def test_record_and_summary(self):
        from offgrid.stats.value_tracker import ValueTracker, DB_PATH
        # Use a temp DB
        import sqlite3
...
class TestP2Imports:
    ...
    def test_all_modules_import(self):
        from offgrid.core.model_capability import ModelTier, ModelStrategy, detect_model_tier, get_strategy, tier_display_name
        from offgrid.notification.flywheel_notifier import FlywheelNotifier, FlywheelNotification
        from offgrid.stats.value_tracker import ValueTracker
