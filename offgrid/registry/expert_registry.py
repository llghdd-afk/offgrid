"""
Expert Registry: in-memory + disk. Loads from builtin_experts/ and ~/.offgrid/experts/.
...
from offgrid.registry.expert_loader import ExpertLoader
...
class ExpertRegistry:
    ...
    def load_builtin(self):
        """Load all YAML files from offgrid/builtin_experts/."""
    ...
    def load_user(self, user_dir: str = None):
        """Load from ~/.offgrid/experts/."""
        if user_dir is None:
            user_dir = os.path.join(Path.home(), ".offgrid", "experts")
    ...
    def save_to_disk(self, expert_name: str, target_dir: str = None):
        ...
        if target_dir is None:
            target_dir = os.path.join(Path.home(), ".offgrid", "experts")
