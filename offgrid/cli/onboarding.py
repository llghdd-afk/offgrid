...
console = Console()
CONFIG_PATH = Path.home() / ".offgrid" / "config.yaml"
...
def _print_welcome():
    console.print()
    console.print(Panel(
        "[bold cyan]OffGrid[/bold cyan]  [dim]离线编码[/dim]\n"
        "[dim]中国开发者的本地 Coding Agent[/dim]",
        border_style="cyan",
        padding=(1, 4),
    ))
    console.print()
    console.print("  欢迎使用 OffGrid！首次使用需要完成以下配置。\n")
